...
+ Supports software control via provided SDKs ([Golang](https://github.com/SydneyOwl/clh-plugin-go-sdk) / [C#](https://github.com/SydneyOwl/clh-plugin-csharp-sdk)).
...
>
> In short: Install `KB3140245` from [here](https://catalog.update.microsoft.com/search.aspx?q=kb3140245) and easyfix from [here](https://download.microsoft.com/download/0/6/5/0658B1A7-6D2E-474F-BC2C-D69E5B9E9A68/MicrosoftEasyFix51044.msi).
