...
public class UDPServerSettings : ReactiveValidationObject
{
    ...
    protected bool Equals(UDPServerSettings other)
    {
        return EnableUDPServer == other.EnableUDPServer &&
               ...
               AutoUploadQSOToCloudlog == other.AutoUploadQSOToCloudlog && RetryCount == other.RetryCount;
    }
    ...
    {
        return HashCode.Combine(EnableUDPServer, EnableConnectionFromOutside, UDPPort, AutoUploadQSOToCloudlog, RetryCount);
    }
}