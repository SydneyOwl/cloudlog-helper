...
public class TokenCollection : List<Token>
{
    ...
    {
        foreach (var AnItem in TheTokenNameDataList) Add(new Token(AnItem.TagName, AnItem.Data));
    }
    ...
    {
        var retTokenCollection = new StringBuilder();
        foreach (var thisToken in this) retTokenCollection.Append(thisToken).Append(" ");
